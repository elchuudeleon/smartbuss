...
$("body").on("click touchstart","#btnGuardar",function(e){
   ...
   $.ajax({
            url:URL+"functions/facturacompra/consultarfacturacompra.php", 
            type:"POST", 
...
$("body").on("click","#btnAgregar",function(e){
  ...
  if($("#tipoDeduccion").val()==1||$("#tipoDeduccion").val()==2){
    ...
    base=$("#baseImpuestos").val(); 
      ...
      $.ajax({
        url:URL+"functions/facturacompra/consultarretencion.php", 
        type:"POST", 
        data: {"empresa":$("[name='datos[idEmpresa]'").val(),"tipoFactura":'compra',"idImpuesto":idConcepto}, 
        dataType: "json",
        }).done(function(msg){
  ...
  if(concepto!=""&&tipo!=""&&valor!=""){
    ...
    +"<td><a href='javascript:void(0)' data-toggle='tooltip' id='eliminar' data-placement='top' title='Eliminar' class='btnEliminar btn btn-icon btn-sm btn-danger btnEliminar'><i class='fas fa-trash'></i></a></td>"
