  ...
  var table = $('#tableEnterprise').DataTable({
      ...
      dom: 'Blfrtip',
        buttons: [
            ...
            autoPrint: true,
            titleAttr: 'IMPRIMIR',
            title:'<table class="table"><thead><tr><th style="float:left;">Smartbuss</th><th ><img src="'+url+logo+'" width="140" height="100">    '+empresa+'</th><th></th><th>'+hoy+'</th></tr><tr><th> </th><th>Nit: '+nit+'-'+digitoVerificador+'</th><th> </th><th> </th></tr> <tr><th></th><th ></th><th> </th></tr><tr><th></th><th > </th><th> </th></tr></thead<tbody><tr></tr></tbody></table>',
            }
        ] 
    });
})
