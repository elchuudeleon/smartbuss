...
$("body").on("change","[name='datos[idEmpleado]'], [name='datos[periodo]']",function(e){
    ...
    sHtmlA+='<tr>'+
            ...
            '<td><select class="form-control select2 cuentaContable" name="adiciones['+index+'][cuentaContable]" id="adiciones['+index+'][cuentaContable]" required ></select>'+
...
// <input type="text" class="form-control moneda mayusculas valor" readonly value="'+element.valor+'" name="adiciones['+index+'][valor]" id="adiciones['+index+'][valor]" placeholder="valor" required></td>
          ...
          if(msg.deduccionesLey!=null){
            ...
            sHtmlL+='<tr class="'+clase+'">'+
                    ...
                    '<td><select class="form-control select2 tercero" name="ley['+index+'][tercero]" id="ley['+index+'][tercero]" required ></select>'+
  ...
  console.log(idEmpresa);
      ...
      $.ajax({
        ...
        dataType: "json",
          ...
          $(".cuentaContable").addClass("select2");
          ...
          $.ajax({
            ...
            var sHtmlT='<option value="">Seleccione</option>';
              msg.forEach(function(element,index){
                  ...
                  sHtmlT+='<option value="'+element[0]+'">'+element.codigoCuentaContable+' - '+element.nombre+'</option>';
              })


              $(".tercero").html(sHtmlT);
              // $(".tercero").addClass("select2");
              $(".tercero").attr("required","required");
