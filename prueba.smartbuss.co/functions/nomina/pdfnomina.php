                          ...
                          <table class="table table-striped mayusculas">
                            ...
                            <tbody>
                              ...
                              <?php $i=0;  foreach($aAdiciones as $indexA=>$iAdiciones){ ?>
                                ...
                                <td  style="width: 40%"><?php echo $iAdiciones["concepto"]; ?></td>

                                <td  style="width: 10%"><?php echo "$".number_format($iAdiciones["valor"],0,".",","); ?></td>
                          ...
                          <table class="table table-striped mayusculas">
                            ...
                            <tbody>
                              ...
                              <?php $i=0;  foreach($aLeyes as $indexA=>$iDeduccion){ ?>
                                ...
                                <td  style="width: 40%"><?php echo $iDeduccion["concepto"]; ?></td>

                                <td  style="width: 10%"><?php echo "$".number_format($iDeduccion["valor"],0,".",","); ?></td>
