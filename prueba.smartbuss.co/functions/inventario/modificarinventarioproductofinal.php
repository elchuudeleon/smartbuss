...
if ($_SESSION['idRol']==1) {
    ...
    if ($datos["tipoOperacion"]==1) {
        ...
        if ($datos["idProducto"]!='') {
            ...
            // $oItem=new Data("producto_proceso","idProducto",$datos["idProducto"]); 
            ...
            // $valorUnitarioNuevo = round($aDatosp["valorUnitario"],8);
            ...
            // $aItem["valorUnitario"]= $valorUnitarioNuevo;

            // $aItem["cantidadMinima"]=1;
            ...
            $aMovimiento['motivo']='Ingreso manual de producto final';
    ...
    if ($datos["tipoOperacion"]==2) {
        ...
        if ($datos["idProductoRestar"]!='') {
            ...
            $aMovimiento['idEmpresa']=$empresa;
            $aMovimiento['motivo']='Resta manual de producto final';
