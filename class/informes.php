...
class Informes extends Sql{
	...
	public function getBalanceComprobacionAcumuladoSA($aDatos=array()){
		...
		if($aDatos["cuentaPrimera"]!=""){ 
			...
			$condicion.=" AND substring(cc.codigoCuenta,1,10)>='".substr($aDatos["cuentaPrimera"],0,10)."'";

		}

		if($aDatos["cuentaSegunda"]!=""){ 

			$condicion.=" AND substring(cc.codigoCuenta,1,10)<='".substr($aDatos["cuentaSegunda"],0,10)."'";
...
public function getBalanceComprobacionAcumuladoA($aDatos=array()){
		...
		if($aDatos["cuentaPrimera"]!=""){ 
			...
			$condicion.=" AND substring(cc.codigoCuenta,1,8)>='".substr($aDatos["cuentaPrimera"],0,8)."'";

		}

		if($aDatos["cuentaSegunda"]!=""){ 

			$condicion.=" AND substring(cc.codigoCuenta,1,8)<='".substr($aDatos["cuentaSegunda"],0,8)."'";
...
public function getBalanceComprobacionAnteriorA($aDatos=array()){
	...
	public function getBalanceComprobacionAcumuladoSC($aDatos=array()){
		...
		if($aDatos["cuentaPrimera"]!=""){ 
			...
			$condicion.=" AND substring(cc.codigoCuenta,1,6)>='".substr($aDatos["cuentaPrimera"],0,6)."'";

		}

		if($aDatos["cuentaSegunda"]!=""){ 

			$condicion.=" AND substring(cc.codigoCuenta,1,6)<='".substr($aDatos["cuentaSegunda"],0,6)."'";
	...
	public function getBalanceComprobacionAcumuladoC($aDatos=array()){
		...
		if($aDatos["cuentaPrimera"]!=""){ 
			...
			$condicion.=" AND substring(cc.codigoCuenta,1,4)>='".substr($aDatos["cuentaPrimera"],0,4)."'";

		}

		if($aDatos["cuentaSegunda"]!=""){ 

			$condicion.=" AND substring(cc.codigoCuenta,1,4)<='".substr($aDatos["cuentaSegunda"],0,4)."'";
	...
	public function getBalanceComprobacionG($aDatos=array()){
		...
		if($aDatos["cuentaPrimera"]!=""){ 
			...
			$condicion.=" AND substring(cc.codigoCuenta,1,2)>='".substr($aDatos["cuentaPrimera"],0,2)."'";

		}

		if($aDatos["cuentaSegunda"]!=""){ 

			$condicion.=" AND substring(cc.codigoCuenta,1,2)<='".substr($aDatos["cuentaSegunda"],0,2)."'";
