  ...
  console.log($("[name='datos[nroFactura]'").val());
   ...
   $.ajax({
      ...
      if(true === $("#frmGuardar").parsley().validate()){
        ...
        Swal.fire({
          title: '¿Está seguro?',
          text: 'Está a punto de crear está factura de venta!',
          icon: 'warning', 
          showCancelButton: true,
          showLoaderOnConfirm: true,
          confirmButtonText: `Si, Continuar!`,
...
$("body").on("click","#btnAgregar",function(e){
  ...
  if(valor!=""){
    ...
    console.log('moneda:');
  	...
  	valorMonedaFinal=Math.round(valorMoneda);
    // var valorMonedaFinal=parseFloat(eliminarMoneda(eliminarMoneda(eliminarMoneda(valor,"$",""),".",""),",",","));
  ...
  if(concepto!=""&&tipo!=""&&valor!=""){
    ...
    if(base!=""){
      ...
      // valorMoneda=eliminarMoneda(valorMoneda,".",",");
    // valorMoneda=parseFloat(eliminarMoneda(eliminarMoneda(eliminarMoneda(valor,"$",""),".",""),",","."));
    ...
    +"<input type='hidden' name='impuesto["+cantidad+"][valor]' id='item["+cantidad+"][valor]' class='form-control valor' value='"+valorMonedaFinal+"' >"+
