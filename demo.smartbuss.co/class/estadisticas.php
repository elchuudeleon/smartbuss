...
class Estadisticas extends Sql{
	
	public function getEestadisticaProcedencia(){

		
		$sql="SELECT c.procedencia,p.nombreProcedencia as nombre, count(procedencia) as total from t_clientes as c
	...
	public function getNegocios($cliente){
		...
		$sql="SELECT estado, count(estado) as total from actividades 
