...
class Inventario extends Sql{
	...
	public function getInventarioProductosTerminados($aDatos=array()){
		...
		$sql="SELECT ipm.tipoMovimiento,sum(ipm.ingreso) as ingreso,sum(ipm.egreso) as egreso,ipm.fechaRegistro,u.nombreUsuario,u.apellidoUsuario,ps.nombre,ps.idProductoServicio,ipm.observaciones,imp.idBodega
